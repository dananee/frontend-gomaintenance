  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        // Layout (Don't touch these, they are working!)
        ...
        // --- 🎨 COLOR UPDATES START HERE ---

        // 1. SELECTED DAY: Change from black to Blue (bg-blue-600)
        selected:
          "bg-blue-600 text-white hover:bg-blue-700 hover:text-white focus:bg-blue-700 focus:text-white shadow-md",

        // 2. TODAY (CURRENT DAY): Light blue background + Blue text
        today: "bg-blue-50 text-blue-600 font-bold border border-blue-200",

        // 3. OUTSIDE DAYS: Keep them gray and subtle
        outside:
