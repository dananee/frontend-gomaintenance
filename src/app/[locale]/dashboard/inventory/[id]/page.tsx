...
export default function InventoryPartDetailsPage() {
  ...
  const dateLocales = { en: enUS, fr: fr, ar: arMA };
  ...
  const { data: movements, isLoading: isMovementsLoading, refetch: refetchMovements } = useQuery({
    queryKey: ["part-movements", id, dateRange?.startDate, dateRange?.endDate],
  ...
  const totalValue = currentTotalStock * (part.unit_price_ht || 0);
        ...
        <TabsContent value="overview" className="space-y-6 animate-in fade-in duration-300">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <PremiumMetricCard
              ...
              value={formatCurrency(part.unit_price_ht || 0)}
              icon={Tag}
              variant="teal"
            ...
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                {/* <CompactDateRangePicker 
                      ...
                      t={(key) => t(`movements.dateRangePicker.${key}`)}
                  /> */}
                <div className="relative flex place-items-center before:absolute before:h-[300px] before:w-[480px] before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-[240px] after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700/10 after:dark:from-sky-900 after:dark:via-[#0141ff]/40 before:lg:h-[360px] w-full">
                  ...
                  <Datepicker
                    i18n={locale}
                    placeholder={t('movements.dateRangePicker.selectRange')}
                    showShortcuts={true}
