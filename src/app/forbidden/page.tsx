  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 p-6 text-center dark:bg-gray-900">
      <div className="flex flex-col items-center gap-4">
        ...
        <div>
          <p className="text-sm uppercase tracking-wide text-gray-500 dark:text-gray-400">Error 403</p>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Access forbidden</h1>
          <p className="mt-2 max-w-xl text-gray-600 dark:text-gray-300">
            You do not have permission to view this page. Please check your role or contact an administrator.
          </p>
        </div>
