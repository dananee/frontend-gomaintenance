...
export function RequestPartModal({ workOrderId, isOpen, onClose, onSuccess }: RequestPartModalProps) {
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    >
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex items-center space-x-2">
                                                <span
                                                    className={`px-2 py-1 rounded-full text-xs font-semibold ${part.quantity > part.min_quantity
                    ...
                    {selectedPart && (
                        <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                            <div className="flex items-center justify-between">
                                <div>
                                    <div className="font-semibold text-blue-900">{selectedPart.name}</div>
                                    <div className="text-sm text-blue-700">SKU: {selectedPart.part_number}</div>
                                </div>
                                <Button
                                    type="button"
                                    variant="ghost"
